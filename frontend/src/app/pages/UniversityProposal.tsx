...
import { Upload, File, X, CheckCircle, AlertCircle, ArrowLeft, Info } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 border border-gray-200">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  Complete the form below to submit your proposal for university-level review
                </p>
              </div>
