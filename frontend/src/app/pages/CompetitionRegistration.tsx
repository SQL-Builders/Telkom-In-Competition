    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-3xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-gray-600 mb-8">The registration form is not available for this competition.</p>
          <button
        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              Complete the form below to register for {competition?.title ?? 'this competition'}
            </p>
          </div>
